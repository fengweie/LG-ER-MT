...
parser.add_argument('--exp', type=str,  default='UAMT_all_noise_discrimitive', help='model_name')
...
parser.add_argument('--discrimitive', type=float,  default=0.0, help='discrimitive')
...
#    shutil.copytree('.', snapshot_path + '/code', shutil.ignore_patterns(['.git','__pycache__']))
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            discrimitive_value = losses.discrimitive_loss(x9_feature[:labeled_bs], label_batch[:labeled_bs])
